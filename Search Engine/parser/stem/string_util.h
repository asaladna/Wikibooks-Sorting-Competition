...
namespace string_util
    ...
    inline char tolower_western(const char c)
        {
        return ((c >= 'A') && (c <= 'Z')) ||
            ((c >= assign_character(char, (char)0xC0)) && (c <= assign_character(char, (char)0xD6))) ||
            ((c >= assign_character(char, (char)0xD8)) && (c <= assign_character(char, (char)0xDE)))
                ? (c + 32) : c;
        }
    ...
    inline char toupper_western(const char c)
        {
        return ((c >= 'a') && (c <= 'z')) ||
            ((c >= assign_character(char, (char)0xE0)) && (c <= assign_character(char, (char)0xF6))) ||
            ((c >= assign_character(char, (char)0xF8)) && (c <= assign_character(char, (char)0xFE)))
                ? (c - 32) : c;
        }
    ...
    inline bool isalpha_western(const char c)
        ...
        return (((c >= 0x41) && (c <= 0x5A)) ||
            ((c >= 0x61) && (c <= 0x7A)) ||
            ((c >= assign_character(char, (char)0xC0)) && (c <= assign_character(char, (char)0xD6)))||
            ((c >= assign_character(char, (char)0xD8)) && (c <= assign_character(char, (char)0xF6))) ||
            ((c >= assign_character(char, (char)0xF8)) && (c <= assign_character(char, (char)0xFF))));
        }
